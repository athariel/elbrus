...
class MeasurementsControllerTest < ActionController::TestCase
  ...
  test "should create measurement" do
    assert_difference('Measurement.count') do
      post :create, measurement: { ratio: @measurement.ratio, name: @measurement.name, product_id: @measurement.product_id }
    end
  ...
  test "should update measurement" do
    patch :update, id: @measurement, measurement: { ratio: @measurement.ratio, name: @measurement.name, product_id: @measurement.product_id }
    assert_redirected_to measurement_path(assigns(:measurement))
  end
